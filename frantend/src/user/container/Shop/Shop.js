...
import { getShopData } from '../../../redux/action/shop.action';
...
function Shop(props) {
  ...
  useEffect(() => {
    const ProductData = products.filter((product) => product.subCategory_id === id)
                            ...
                            <div className="rounded position-relative fruite-item">
                              ...
                              <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                ...
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                  ...
                                  <Link onClick={() => addToCart(v.id)} href="#" className="btn border border-secondary rounded-pill px-3 text-primary">
