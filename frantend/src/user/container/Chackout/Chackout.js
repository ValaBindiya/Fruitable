                        ...
                        <div className="row g-5">
                            <div className="col-md-12 col-lg-6 col-xl-7">
                                <div className="row">
                                    <div className="col-md-12 col-lg-6">
                                        <div className="form-item w-100">
                                            ...
                                            <input type="text" className={`form-control ${themeContext.theme}`} />
                                        </div>
                                    </div>
                                    <div className="col-md-12 col-lg-6">
                                        <div className="form-item w-100">
                                ...
                                <div className="form-item">
                                    ...
                                    <input type="text" className={`form-control ${themeContext.theme}`} placeholder="House Number Street Name" />
                                </div>
                                <div className="form-item">
                                ...
                                <div className="form-item">
                                    ...
                                    <input type="tel" className={`form-control ${themeContext.theme}`} />
                                </div>
                                <div className="form-item">
                                    <label className="form-label my-3">Email Address<sup>*</sup></label>
                                    <input type="email" className={`form-control ${themeContext.theme}`} />
                                </div>
                                <div className="form-check my-3">
                                    <input type="checkbox" className={`form-check-input ${themeContext.theme}`} id="Account-1" name="Accounts" defaultValue="Accounts" />
                                ...
                                <div className="form-item">
                                    <textarea name="text" className={`form-control ${themeContext.theme}`} spellCheck="false" cols={30} rows={11} placeholder="Oreder Notes (Optional)" defaultValue={""} />
                                </div>
                            </div>
